...
namespace lbfgs
{
    ...
    struct lbfgs_parameter_t
    {
         ...
         */
        double f_dec_coeff = 1.0e-4; //decrease condition
         ...
         */
        double s_curv_coeff = 0.9; //curvant codition
                                        ...
                                        const lbfgs_parameter_t &param)
    {
        ...
        auto S_right = param.f_dec_coeff * gp.dot(s);
        auto C_right = param.s_curv_coeff * gp.dot(s);
        ...
        while(true){
            ...
            if (f_k0 - f_k1 < stp * S_right){
                right = stp;
            }
            else if(g.dot(s) < C_right){
                left = stp;
            }
            else{
                f = f_k1;
